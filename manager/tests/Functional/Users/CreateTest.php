...
class CreateTest extends DbWebTestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $this->client->submitForm('Создать пользователя', [
            'form[firstName]' => 'Tom',
            'form[lastName]' => 'Bent',
        ...
        $this->assertSame(200, $this->client->getResponse()->getStatusCode());
        $this->assertContains('Пользователи', $crawler->filter('title')->text());
    ...
    public function testNotValid(): void
    {
        ...
        $crawler = $this->client->submitForm('Создать пользователя', [
            'form[firstName]' => '',
            'form[lastName]' => '',
