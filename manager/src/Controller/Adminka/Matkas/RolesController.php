...
use App\Model\Adminka\UseCase\Matkas\Role\Copy;
use App\Model\Adminka\UseCase\Matkas\Role\Create;
use App\Model\Adminka\UseCase\Matkas\Role\Edit;
use App\Model\Adminka\UseCase\Matkas\Role\Remove;
...
/**
 * @Route("/adminka/matkas/roles", name="adminka.matkas.roles")
 */
class RolesController extends AbstractController
{
    ...
    public function index(RoleFetcher $fetcher): Response
    {
        ...
        return $this->render('app/adminka/matkas/roles/index.html.twig', compact('roles', 'permissions'));
    }
    ...
    public function create(Request $request, Create\Handler $handler): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                ...
                return $this->redirectToRoute('adminka.matkas.roles');
        ...
        return $this->render('app/adminka/matkas/roles/create.html.twig', [
    ...
    public function edit(Role $role, Request $request, Edit\Handler $handler): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                $handler->handle($command);
                return $this->redirectToRoute('adminka.matkas.roles.show', ['id' => $role->getId()]);
            } catch (\DomainException $e) {
                $this->errors->handle($e);
                $this->addFlash('error', $e->getMessage());
            }
        ...
        return $this->render('app/adminka/matkas/roles/edit.html.twig', [
            'role' => $role,
            'form' => $form->createView(),
        ]);
    }
    ...
    public function copy(Role $role, Request $request, Copy\Handler $handler): Response
    {
        ...
        return $this->render('app/adminka/matkas/roles/copy.html.twig', [
            'role' => $role,
            'form' => $form->createView(),
        ]);
    }
    ...
    {
        return $this->render('app/adminka/matkas/roles/show.html.twig', compact('role'));
    }
}
