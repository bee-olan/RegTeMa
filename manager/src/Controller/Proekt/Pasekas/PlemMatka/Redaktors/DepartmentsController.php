...
/**
 * @Route("/proekt/pasekas/matkas/plemmatkas/{plemmatka_id}/redaktorss/departmentss", name="proekt.pasekas.matkas.plemmatkas.redaktorss.departmentss")
...
//dd($plemmatka->getId()->getValue());
        ...
        return $this->render('proekt/pasekas/matkas/plemmatkas/redaktorss/departmentss/index.html.twig', [
            'plemmatka' => $plemmatka,
