...
/**
 * @ORM\Entity
 * @ORM\Table(name="matkis_u4astniks_u4astniks")
 */
class U4astnik
{
    /**
     * @var Id
     * @ORM\Column(type="matkis_u4astniks_u4astnik_id")
     * @ORM\Id
     */
    private $id;
    /**
     * @var Group
     * @ORM\ManyToOne(targetEntity="App\Model\Matkis\Entity\U4astniks\Group\Group")
    ...
    /**
     * @var Email
     * @ORM\Column(type="matkis_u4astniks_u4astnik_email")
     */
    private $email;
    /**
     * @var Status
     * @ORM\Column(type="matkis_u4astniks_u4astnik_status", length=16)
     */
    private $status;
