...
namespace App\Model\Matkis\Entity\Rasas\Rasa;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="matkis_rasas_rasas")
 */
class Rasa
{
    /**
     * @var Id
     * @ORM\Column(type="matkis_rasas_rasa_id")
     * @ORM\Id
     */
    private $id;
    ...
    //  * @ORM\OneToMany(
    //  *     targetEntity="App\Model\Matkis\Entity\Rasas\Rasa\Linia\Linia",
