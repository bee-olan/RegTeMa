...
namespace App\Model\Adminka\Entity\Matkas\Kategoria;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="admin_matkas_kategorias")
 */
class Kategoria
{
    /**
     * @var Id
     * @ORM\Column(type="admin_matkas_kategoria_id")
     * @ORM\Id
     */
    private $id;
     ...
     * @ORM\Column(type="admin_matkas_kategoria_permissions")
     */
    private $permissions;
    /**
     * @ORM\Version()
