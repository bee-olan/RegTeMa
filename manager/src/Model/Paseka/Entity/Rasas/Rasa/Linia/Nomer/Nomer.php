...
namespace App\Model\Paseka\Entity\Rasas\Rasa\Linia\Nomer;

use App\Model\Paseka\Entity\Rasas\Rasa\Linia\Linia;
//use App\Model\Paseka\Entity\Rasas\Rasa\Linia\Nomer\Sparings\Sparing;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity
 * @ORM\Table(name="paseka_rasas_rasa_linia_nomers")
 */
class Nomer
{
    /**
     * @var Linia
     * @ORM\ManyToOne(targetEntity="App\Model\Paseka\Entity\Rasas\Rasa\Linia\Linia", inversedBy="nomers")
    ...
    /**
     * @var Id
     * @ORM\Column(type="paseka_rasas_rasa_linia_nomer_id")
     * @ORM\Id
     */
    private $id;
