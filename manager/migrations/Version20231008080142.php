 ...
 */
final class Version20231008080142 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dre_ras_rod_lini_wet_nomw_truts (id UUID NOT NULL, nomwet_id UUID NOT NULL, name_ot VARCHAR(255) NOT NULL, sort_trut INT NOT NULL, PRIMARY KEY(id))');
