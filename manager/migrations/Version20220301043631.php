...
final class Version20220301043631 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE paseka_rasas_rasas_pcheloships (id UUID NOT NULL, rasa_id UUID NOT NULL, pchelowod_id UUID NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_78D143A781DBD4D8 ON paseka_rasas_rasas_pcheloships (rasa_id)');
        $this->addSql('CREATE INDEX IDX_78D143A798D61FA6 ON paseka_rasas_rasas_pcheloships (pchelowod_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_78D143A781DBD4D898D61FA6 ON paseka_rasas_rasas_pcheloships (rasa_id, pchelowod_id)');
        $this->addSql('COMMENT ON COLUMN paseka_rasas_rasas_pcheloships.rasa_id IS \'(DC2Type:paseka_rasas_rasa_id)\'');
        $this->addSql('COMMENT ON COLUMN paseka_rasas_rasas_pcheloships.pchelowod_id IS \'(DC2Type:paseka_pchelowods_pchelowod_id)\'');
        ...
        $this->addSql('ALTER TABLE paseka_rasas_rasas_pcheloships ADD CONSTRAINT FK_78D143A781DBD4D8 FOREIGN KEY (rasa_id) REFERENCES paseka_rasas_rasas (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE paseka_rasas_rasas_pcheloships ADD CONSTRAINT FK_78D143A798D61FA6 FOREIGN KEY (pchelowod_id) REFERENCES paseka_pchelowods_pchelowods (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE paseka_rasas_rasa_pcheloship_linias ADD CONSTRAINT FK_60325FDDDB331213 FOREIGN KEY (pcheloship_id) REFERENCES paseka_rasas_rasas_pcheloships (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE paseka_rasas_rasa_pcheloship_kategors ADD CONSTRAINT FK_345E3042DB331213 FOREIGN KEY (pcheloship_id) REFERENCES paseka_rasas_rasas_pcheloships (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE paseka_rasas_rasas_pcheloships');
