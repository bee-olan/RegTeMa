 ...
 */
final class Version20230427062058 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adminka_otec_ras_linia_nomers (id UUID NOT NULL, linia_id UUID NOT NULL, name VARCHAR(255) NOT NULL, oblet VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, matka_linia VARCHAR(255) NOT NULL, matka_nomer VARCHAR(255) NOT NULL, otec_linia VARCHAR(255) NOT NULL, otec_nomer VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE adminka_otec_ras_linias (id UUID NOT NULL, rasa_id UUID NOT NULL, name VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
